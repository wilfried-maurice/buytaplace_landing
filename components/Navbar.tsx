...
import { Menu, X, Plane, Bus, Handshake } from 'lucide-react';
        ...
        <div className="container mx-auto px-6 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-6">
            <button
              ...
              className={`font-medium transition-colors flex items-center gap-2 ${isScrolled ? 'text-slate-600 hover:text-sky-600' : 'text-white/90 hover:text-white'}`}
            >
              <Handshake size={18} />
              Devenir Partenaire
            </button>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden absolute top-full left-0 w-full bg-white border-t border-slate-100 shadow-xl py-4 px-6 flex flex-col space-y-4">
            <button
              ...
              className="flex items-center justify-center gap-2 w-full py-3 text-slate-600 font-medium border border-slate-200 rounded-xl hover:bg-slate-50"
            >
              <Handshake size={18} />
              Devenir Partenaire
            </button>
